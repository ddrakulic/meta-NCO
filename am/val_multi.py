...
def run(opts):
    ...
    for epoch in range(0, 6100000,200):
        ...
        for task in tasks_list:
            ...
            for multi_model_cost, ins_cost in zip(all_costs, val_dict_costs_ins_heu[str(task)]):
                # print(multi_model_cost.item(), ins_cost)
            ...
            total_opt_gap_across_tasks+=opt_gap_wrt_ins_heu_cur_task

        print("total_opt_gap_across_tasks ",total_opt_gap_across_tasks)
