...
def run(opts):
    ...
    first_time = dict_val_epoch_vs_best_till_now[0]['time_of_cur_epoch']
    first_time = datetime.strptime(first_time, '%Y-%m-%d %H:%M:%S')
    print(first_time)

    for epoch_id in sorted(dict_val_epoch_vs_best_till_now):
    ...
    print(dict_epoch_vs_time_solutions_at_0_tune)
