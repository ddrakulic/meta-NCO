...
class Supervisor(object):
    def __init__(self, args, multi_handler, log_dir, print_avg_metric_test=False):
        self.args = args
        self.log_dir = log_dir
        # Instantiate the network
        self.handler = multi_handler
    ...
    def train(self, with_validation=True):
        ...
        while True:
            ...
            for _ in range(self.args.train_steps_per_epoch):
            ...
            print("=-Training, time: {0:.2f}min".format(training_time / 60), end="")
    ...
    def validate(self, epoch=0):
        ...
        print("=--Validation, time: {0:.3f}min, sum_val_metric: {1:.3f}, sum_val_loss: {2:.3f}".format(
            validation_time / 60, sum_val_metric, sum_val_loss))

        self.write_val_stats(epoch, sum_val_loss, sum_val_metric, self.log_dir)

        return sum_val_loss, sum_val_metric
